// src/app/auth/line/callback-simple/page.js
'use client';

import { useEffect, useState, Suspense } from 'react';
import { useRouter, useSearchParams } from 'next/navigation';
import { handleLineCallbackSimple } from '@/utils/lineAuthSimple';

function LineCallbackSimpleContent() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        // 處理 LINE 登入
        const user = await handleLineCallbackSimple(code, state);
...
export default function LineCallbackSimple() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-r from-green-100 to-blue-100">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
